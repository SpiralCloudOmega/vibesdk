...
const COMMON_AGENT_CONFIGS = {
    screenshotAnalysis: {
        ...
        max_tokens: 8000,
        temperature: 1,
        fallbackModel: AIModels.KIMI_K2_6,
    },
    realtimeCodeFixer: {
...
//======================================================================================
// Default Kimi Code config (used when PLATFORM_MODEL_PROVIDERS is not set)
//======================================================================================
/* These are the default out-of-the-box Kimi Code (Moonshot) models. Requires MOONSHOT_API_KEY. */
